...
void extract_autocorrect_A(char* bin, char* msg, char* out, size_t msgsize, int off);
void extract_autocorrect_B(char* bin, char* msg, char* out, size_t msgsize, int off);
